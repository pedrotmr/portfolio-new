...
const IgProfilePicture = ({ className, style, initial, animate, transition }: IgProfilePictureProps) => {
  return (
    <motion.div
    ...
    >
      <svg width="74" height="74" viewBox="0 0 74 74" fill="none" xmlns="http://www.w3.org/2000/svg">
        <circle cx="37" cy="37" r="34" stroke="url(#paint0_linear_658_19773)" strokeWidth="2.5"></circle>
        <defs>
          <linearGradient
        ...
        <image x="7" y="7" width="60" height="60" href="/images/perfil_3.jpg" clipPath="circle(30)" />
      </svg>
    </motion.div>
  );
};
