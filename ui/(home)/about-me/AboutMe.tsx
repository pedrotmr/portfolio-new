...
const AboutMe = () => {
  ...
  return (
    <section ref={scrollRef} className="relative z-20 h-[450dvh] w-full">
      {inView && (
        <div className="sticky top-1/2 z-20 m-auto flex max-w-6xl -translate-y-1/2 items-center justify-center gap-20 text-[clamp(10px,3vw,2.25rem)] font-bold leading-tight text-beige">
          ...
          <motion.img
            ...
            alt="pedro's image"
            className="grayscales aspect-[3/4] h-auto w-[35%] cursor-none rounded-md object-cover brightness-110 contrast-125 will-change-transform hover:scale-105"
            width={748}
            height={929}
            style={imageStyles}
          />
