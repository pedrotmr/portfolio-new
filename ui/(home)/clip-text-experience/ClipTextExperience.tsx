...
const ClipTextExperience = () => {
  ...
  return (
    <motion.section ref={scrollRef} className="h-[300dvh]">
      <motion.div
        style={textStyle}
        className={`
          sticky top-1/2 z-20 mx-auto flex justify-center text-[clamp(1px,4vw,3rem)] font-bold
          leading-normal text-beige
        `}
      >
