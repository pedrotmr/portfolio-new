...
export const projects: Project[] = [
  {
    ...
    image: '/images/projects/juicy.png',
  },
  // {
  //   name: 'Schlepper',
  ...
  {
    name: 'React Shortcut Keys',
    github: 'https://github.com/pedrotmr/react-shortcut-keys',
    link: 'https://www.npmjs.com/package/react-shortcut-keys',
    description: [
      'This package provides a way to handle keyboard shortcuts in a React application.',
      'It includes a custom hook and a component to facilitate the handling of keyboard shortcuts, with support for case sensitivity and additional customization options.',
    ],
    tags: ['TypeScript', 'React', 'React Testing Library', 'Changesets', 'Github Actions'],
    image: '/images/projects/react-shortcut-keys.png',
  },
];
